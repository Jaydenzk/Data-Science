...
xgb_reg_fourteen_features = xgb.XGBRegressor()
xgb_reg_fourteen_features.fit(X_train, y_train)
training_preds_xgb_reg = xgb_reg_fourteen_features.predict(X_train)
val_preds_xgb_reg = xgb_reg_fourteen_features.predict(X_test)
...
with open('xgb_reg_fourteen_features', 'wb') as pickle_file:
  pickle.dump(xgb_reg_fourteen_features, pickle_file)
